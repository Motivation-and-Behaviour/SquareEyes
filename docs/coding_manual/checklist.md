...
- [ ] Assign yourself to a participant's timepoint on Asana.
- [ ] Download the zip file of the `Images` folder for the participant.
- [ ] Use 7-Zip to extract the contents of the zip file for coding.
...
- [ ] Select `Recognitions > Set bounding box options… > Change the slider` to 0.3 and press OK.
...
Below is a video that shows the full process of setting up Timelapse and coding a participant.[^1]
...
[^1]:
    <small>2026-07-14 </small>This video is slightly outdated.
    When the video contradicts the written instructions, follow the instructions instead.
